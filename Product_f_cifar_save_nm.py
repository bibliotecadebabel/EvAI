...
from DNA_Phase_space_f_disk_nm import DNA_Phase_space
...
from DNA_creators import Creator_from_selection_nm as Creator
from Dyamic_DNA_f_methods import update_from_select_nm  as space_updater
...
def create_objects(status, loaded_network):
    ...
    space=DNA_Graph(center,1,(x,y),condition,actions,
        version,creator,selector=status.Selector, num_morphisms=5)
    if status.Alai:
